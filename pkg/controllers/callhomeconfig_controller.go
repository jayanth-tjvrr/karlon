...
//+kubebuilder:rbac:groups=core.kkarlon.io,resources=callhomeconfigs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.kkarlon.io,resources=callhomeconfigs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.kkarlon.io,resources=callhomeconfigs/finalizers,verbs=update
...
func (r *CallHomeConfigReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	log.V(1).Info("kkarlon callhomeconfig")
	var chc kkarlonv1.CallHomeConfig
