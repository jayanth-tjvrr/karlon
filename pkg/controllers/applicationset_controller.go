...
func reconcileApplicationSet(
	...
	log.Info("reconciling applicationset (possible kkarlon app)")
	...
	if app.Labels == nil || app.Labels["kkarlon-type"] != "application" {
		log.V(1).Info("applicationset is not an kkarlon app, skipping...")
