...
//+kubebuilder:rbac:groups=core.kkarlon.io,resources=clusterregistrations,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.kkarlon.io,resources=clusterregistrations/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.kkarlon.io,resources=clusterregistrations/finalizers,verbs=update
...
func (r *ClusterRegistrationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	log.V(1).Info("kkarlon clusterregistration")
	var cr kkarlonv1.ClusterRegistration
	...
	if !controllerutil.ContainsFinalizer(&cr, kkarlonv1.ClusterRegistrationFinalizer) {
		controllerutil.AddFinalizer(&cr, kkarlonv1.ClusterRegistrationFinalizer)
...
func (r *ClusterRegistrationReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&kkarlonv1.ClusterRegistration{}).
		Complete(r)
}
...
func updateState(
	...
	log logr.Logger,
	cr *kkarlonv1.ClusterRegistration,
	state string,
	msg string,
	result ctrl.Result,
) (ctrl.Result, error) {
...
func reconcileDelete(
	...
	controllerutil.RemoveFinalizer(cr, kkarlonv1.ClusterRegistrationFinalizer)
